...
public class CheckoutPage 
{
	...
	private By passwordLocator = By.xpath("//div[@class='field-password-policy']/descendant::input[@aria-label='Password input']");
	...
	private By placeOrderLocator = By.xpath("//div[@id='payment-confirmation']/descendant::button[@type='submit']");
	
	private By orderConfirmationLocator = By.id("order-reference-value");
